...
def gerarArquivos(nrNota):
    ...
    path = 'C:\\Users\\Fernando\\anaconda3\\envs\\projetoImg\\etiquetas\\'
...
for i, image in enumerate(images):
    ...
    # nome do arquivo ex: image0-etiqueta.png




    #text = str(((pytesseract.image_to_string(Image.open(fname2)))))
    #text1 = text.splitlines()  
    #print(text1)
    #print(text1[3])

    #imRt.save(fname3,"PNG")
    #imRt.save(fname4,"PNG")
    #imRt.save(fname5,"PNG")
    
    #indices = [1,2,3,4,5]
    #select_elements1 = [text1[index] for index in indices]
    ...
    #text = str(((pytesseract.image_to_string(Image.open(fname3)))))
    ...
    #indices = [1,2,3,4,5]
    #select_elements2 = [text2[index] for index in indices]
    #print(select_elements2)
    #exit(90)
    ...
    #print("NOVO Current month:", f"{todays_date.month:02d}"   ) 
    #print("Current day:", todays_date.day)

    #print("tipo todays_date.year ", type(todays_date.year))
    ...
    #print("NOVA ANO/MES ATUAL :", str(ano) + str(mes))
    #print("NOVA ANO/MES ANTERIOR :", str(anoAnt) + str(mesAnt))

    #print("Atual", ano, mes)
    #print("Anterior", anoAnt, mesAnt)
...
def processa_imagem(medidas, im):
    ...
    imRt = im.crop((medidas))
    fileNameImg = 'nameImagem.png'

    imRt.save(fname2,"PNG")
