...
def processa_imagem(medidas, im):
    ...
    if not texto :
        ...
        if len(r_filtered_list3) < 10 :
            print("somente o CEP")
            

            localizar_nt1 = re.compile(".*Nota fiscal:")
            r_filtered_list4 = list(filter(localizar_nt1.match, new_teste ))
            print("--- r_filtered_list4 --->", r_filtered_list4)
            localiza4 = new_teste.index(r_filtered_list4)
            print("localiza4 -->>", localiza4)

            print("calculo r_filtered_list4, r_filtered_list4+2-->", r_filtered_list4, r_filtered_list4+2)
