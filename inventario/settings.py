...
if platform.system() == "Linux":
    SECRET_KEY = env_var('SECRET_KEY')
    ALLOWED_HOSTS = ['10.168.254.165', '44.202.8.138']
    DATABASES = {
        'default': {
    ...
    print("não reconheço o sistema operacional")
...
#--- Logging -------------------------------------------------------------------------------início
# alterado para usar como debug salvando em arquivos.
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        'default': {
            ...
            'filename': 'uploadnf/log/newMylog.log',
            'maxBytes': 1024*1024*2,  # 15 Mb
            'backupCount': 5,
            'formatter': 'standard',
        },
        'request_handler': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': 'uploadnf/log/django-request.log',
