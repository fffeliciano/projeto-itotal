...
class Produtos(models.Model):
    codprod = models.IntegerField(unique=True)
...
class Embalagens(models.Model):
    embalagens = models.ForeignKey(Produtos,related_name='embalagens', on_delete=models.CASCADE)
    #embalagens = models.ForeignKey(Produtos, on_delete=models.CASCADE)
    ...
    #codprod=models.ForeignKey(Produtos, related_name='embalagens', on_delete=models.CASCADE)
