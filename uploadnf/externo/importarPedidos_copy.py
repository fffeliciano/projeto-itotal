...
while True:
    ...
    class Pedidos(object):
        ...
        def __init__(self, data, numero, vendedor, totalvenda, situacao, dataSaida, numeroPedidoLoja, nome, cnpj, endereco, numero_end, bairro, complemento, cidade, cep, uf, email, celular, serie, numero_nf, dataEmissao_nf, valorNota, chaveAcesso, qtvol, cgc_transp, codigo_rastreamento ):
            self.obsped = ""
            self.obsrom = ""
