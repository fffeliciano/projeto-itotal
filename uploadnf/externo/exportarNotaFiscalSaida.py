...
load_dotenv()
#url = "https://mbp.f3system.com.br/pedidos/notasfiscais/"
...
while t <= tp:
    ...
    conn = http.client.HTTPConnection("http://localhost:8000")
	...
	#print("Estou bloqueando o programa, antes de enviar os dados.")
	#exit(87)
