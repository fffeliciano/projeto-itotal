...
date_N_days_ago = datetime.now() - timedelta(hours=120)
#timedelta(hours=24)
...
while True:
    ...
    print("payload =x da questão==> ", payload)
    #exit(9)
    ...
    try:
        ...
        with open('dados_bling_teste.json', 'a', encoding='utf-8') as f:
    ...
    if response == 200:
        print("response ==200 -- proximo comando continue ")
        continue
