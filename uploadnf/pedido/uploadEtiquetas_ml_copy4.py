    ...
    if not texto :
        ...
        for n in texto:
            ...
            if len(n) == 23:
                ...
                numped_mktpl_origin = numped_mktpl[2:]
            ...
            numped_mktpl_base = numped_mktpl_origin.replace(" ","")
            print("tamanho do numero do pedido numped_mktpl_base:", len(numped_mktpl_base))
