    ...
    if not texto :
        ...
        for n in texto:
            ...
            if len(n[3:].strip()) == 5:
                ...
                #y = w[0]
                print("Numero da NOTA FISCAL : ===> :", n[3:].strip())
                #print("y ===>", y['numnf'])
                novoNome = n[3:].strip() 
...
def lerEtiquetas_ml(name_file):
    ...
    for i, image in enumerate(images):
        ...
        #medidas1 = [1130,2300,1500,2370]
        medidas1 = [1150,2250,1520,2340]
        print("# Etiqueta 1")
        ...
        #medidas1 = [2960,2300,3330,2370]
        medidas1 = [2980,2250,3380,2340]
        print(" Etiqueta 2")
        print("medidas :", medidas)
        print("medidas1 :", medidas1)
        ...
        #medidas1 = [4800,2300,5180,2370]
        medidas1 = [4810,2250,5180,2340]
        print("# Etiqueta 3")
        print("medidas :", medidas)
...
#z = lerEtiquetas_ml("xml/mercadoLivre_18102022_6.pdf")
