...
def processa_imagem(medidas, im):
    ...
    if not texto :
      ...
      #!  os.remove(fileNameImg)
        ...
        #nomeArquivo = str(int(nfstr[12:18])) if str(int(nfstr[12:18])) != null else "102022" 
...
def lerEtiquetas_magalu(name_file):
    ...
    tamanho = len(images)
    print("qty paginas do arquivo de imagem" ,tamanho)
    print("enumerate : paginas do arquivo de imagem", enumerate(images))
