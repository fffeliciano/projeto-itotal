...
<script src="/home/ubuntu/projeto-es/suporte/nr-1215.min.js.download"></script>
...
<style type="text/css">
	...
	.tracking,
	.destinatario div:nth-child(2) {
		margin-left: 10px;
	}
	.vertical .cod-barras-cep {
		margin-left: 10px;
		position: relative;
		float: left;
		max-width: 50%;
	...
	.rota {
		...
		font-size: 20px;
		position: absolute; right: 0px; bottom: 110px;
	}
	.inicial-destinatario {
		margin-bottom: -15px;
    ...
    if tt.find("B2W")!=-1:
            ...
            for n in resultado:
                ...
                for i in images:
                    ...
                    new_src_full = "/home/ubuntu/projeto-es/suporte/" + new_src
                ...
                #    fh.write(arquivo_html)


  #             imgkit.from_file(arquivo_html, fileName1 )

                pdfkit.from_string(arquivo_html,fileName,configuration=config, options=options)



            #pdfkit.from_file( 'teste5a.html', './etiquetas/teste4b7l.pdf', configuration = config)
            #pdfkit.from_string( arquivo_html, 'etiquetas/teste5c.pdf', configuration = config)
...
lerEtiquetas('Bling - Impressão Etiquetas de Envio-15-02.html')
