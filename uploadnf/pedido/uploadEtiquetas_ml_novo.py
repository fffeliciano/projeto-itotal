...
def processa_imagem(medidas, im, medidas1):
    ...
    if not texto :
        ...
        for x in texto:
            print("imprimendo valor da lista testo, x ===>", x)
        ...
        for n in texto:
            ...
            #print("*****codRastreio: ", numped_mktpl)
            #title1 = numped_mktpl[:6]
            #print("title1 :", title1)
            #if title1 == "Venda:":
            #    numped_mktpl_base = numped_mktpl[7:]
            #else:
            #    numped_mktpl_base = numped_mktpl[9:]
            
            #print("resultado do numero do pedido :", numped_mktpl_base)
            #print("resultado do numero do pedido clean :", numped_mktpl_base.replace(" ",""))
            #print("tamanho do numero do pedido :", len(numped_mktpl_base.replace(" ","")))

            print("IMPORTANTE ********>>>", len(n[5:].strip())) 
            ...
            if len(n[4:].strip()) == 5:
                ...
                #y = w[0]
                print("Numero da NOTA FISCAL : ===> :", n[4:].strip())
...
def lerEtiquetas_ml_novo(name_file):
    ...
    for i, image in enumerate(images):
        ...
        if "Despache as suas vendas" in text1[0] :
            print("****** Gloria ****** achei a pre-lista de ***Despache as suas vendas***")
...
#z = lerEtiquetas_ml("xml/ML071220221232.pdf")

#z = lerEtiquetas_ml_novo("xml/Etiqueta-MercadoEnvios-1679073099_v1.pdf")
