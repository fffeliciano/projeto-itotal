...
def processa_imagem(medidas, im, medidas1):
    ...
    if not texto :
        ...
        for n in texto:
            ...
            if len(numped_mktpl_base.replace(" ","")) == 16:
                numped_mktpl = n #if n[0:2].find('0') > 0 else n[0:2].replace('0','O') + n[2:13]
...
# z = lerEtiquetas_ml("xml/ml_etiqueta_nova.pdf")
