...
def lerEtiquetas_magalu_correios_novo(name_file):

    logger.info("Rodando lerEtiquetas Magalu")
    ...
    for i, image in enumerate(images):
        ...
        # Etiqueta 2
        ###############
        # medidas da segunda etiqueta, a4 , lado direito, canto superior
        medidas = [2067,0,4134,2924]
        medidas1 = [3350, 1460,3560,1530]
        #print(" Etiqueta 2")
        #print("medidas :", medidas)
        #print("medidas1 :", medidas1)
        ...
        # Etiqueta 3
        ###############
        # medidas da terceira etiqueta, a4 , lado esquerdo, canto inferior
        medidas = [0,2925,2067,5847]
        medidas1 = [1330,4335,1550,4410]
        #print("# Etiqueta 3")
        #print("medidas :", medidas)
