...
from fornecedor.models import NotasFiscais, RetItens
...
from fornecedor.forms import RetItensForm
...
def tfaa_update(request, id):
    ...
    if request.method == 'POST':
        form = RetItensForm(request.POST, instance=tfaa )
    else:
        form = RetItensForm(instance=tfaa)
