...
urlpatterns = [
    ...
    path('pnf/<slug:codNfSerie>/', views.pnf_exporta, name='pnf_exporta'),
    ...
    path('etiquetas_magalu/', views.etiquetas_magalu, name='etiquetas_magalu'), 
    path('etiquetas_magalu_color/', views.etiquetas_magalu_color, name='etiquetas_magalu_color'), 
    path('etiquetas_magalu_correios/', views.etiquetas_magalu_correios, name='etiquetas_magalu_correios'), 
    path('etiquetas_magalu_correios_novo/', views.etiquetas_magalu_correios_novo, name='etiquetas_magalu_correios_novo'), 

    path('etiquetas_shopee/', views.etiquetas_shopee, name='etiquetas_shopee'), 
    path('etiquetas_ml/', views.etiquetas_ml, name='etiquetas_ml' ),
    path('etiquetas_ml_novo/', views.etiquetas_ml_novo, name='etiquetas_ml_novo' ),
