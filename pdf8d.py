...
def processa_imagem(medidas, im):
    ...
    if not texto :
        ...
        print("achei texto vazio de novo", texto)
        print("remove")
        os.remove(fileNameImg)
    else:
        ...
        print("select_elements1 ------------------->", select_elements1)

        for n in select_elements1:
            
            print("str(n[0:4]) --------------->>", str(n[0:4]))
...
images = convert_from_path("xml/shopee-26-05-2022-3.pdf", 500 )
