...
with open("./filehtml/BlingImpressãoEtiquetasEnvio_0.html" , 'r', encoding='utf-8') as fp:
...
if tt.find("B2W")!=-1:
        ...
        for n in resultado:
            ...
            for i in images:
                i['src'] = i['src'].replace("./BlingImpressãoEtiquetasEnvio_0_files", "/home/ubuntu/projeto-es/suporte")
            ...
            pdfkit.from_string(arquivo_html,fileName,configuration=config)
