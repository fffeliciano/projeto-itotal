...
def processa_imagem(medidas, im):
    ...
    if not texto :
        ...
        nomeArquivo = str(int(nfstr[12:17]))
        print(" nomeArquivo ===>", nomeArquivo)

        img_nameFile = str(int(nfstr[12:17]))+'.png'

        print("--- str(int(nfstr[12:17])) --->", str(int(nfstr[12:17])))
        print("--- img_nameFile --->", img_nameFile)
        
        #print("--- str(int(nfstr[12:17])) --->", str(int(nfstr[:-6])))
        #print("--- img_nameFile --->", img_nameFile)

        text_nameFile = str(int(nfstr[12:17]))+ "-dadosetq" + '.txt'
...
#images = convert_from_path("xml/magalu-4.pdf", 500,poppler_path=r'C:\Program Files\poppler-0.67.0_x86\poppler-0.67.0\bin')
images = convert_from_path("xml/magalu-4.pdf", 500)
